...
cmake -DCMAKE_BUILD_TYPE=Release -DX86_ABI=X86-64 -DLITE=ON -DFFMPEG=/workspace/.3rd/linux-ffmpeg/ffmpeg -DCUDA:BOOL=ON -DMINIO:BOOL=ON -DMINIO_PATH=/dataset/lichao/github/minio-cpp/build/vcpkg_installed/x64-linux/ ..
