#ifndef _EAGLEEYE_ELEMENTWISE_NAVIE_IMPL_H_
#define _EAGLEEYE_ELEMENTWISE_NAVIE_IMPL_H_
#include <cmath>
...
template <typename T, T naive_op(T, T)>
static void naive_elementwise_op_broadcast_1c(const T* x_data,
                                           const T* y_data,
                                           T* out_data,
                                           int batch,
                                           int num) {
...
template <typename T, T naive_op(T, T)>
static void naive_elementwise_op_broadcast_n1(const T* x_data,
                                           const T* y_data,
                                           T* out_data,
                                           int batch,
                                           int num) {
