...
#ifndef _EAGLEEYE_REDUCE_PROD_H_
#define _EAGLEEYE_REDUCE_PROD_H_
#include <stdint.h>
namespace eagleeye {
namespace math {
namespace arm {
...
void reduce_prod_nc(const T* src,
  ...
  float* tmp_out = new float[1*channel_in*height_in*width_in];
...
void reduce_prod_ch(const T* src,
  ...
  float* tmp_out = new float[num_in*1*height_in*width_in];
...
void reduce_prod_hw(const T* src,
  ...
  float* tmp_out = new float[num_in*channel_in*1*width_in];
