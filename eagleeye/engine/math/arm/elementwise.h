#ifndef _EAGLEEYE_ELEMENTWISE_H_
#define _EAGLEEYE_ELEMENTWISE_H_
#include <algorithm>
#include <string>
#include <vector>
namespace eagleeye {
...
template <typename T>
void elementwise_add_broadcast_1c(const T* dinx, const T* diny, T* dout, int batch, int num);

template <typename T>
void elementwise_add_broadcast_n1(const T* dinx, const T* diny, T* dout, int batch, int num);
...
template <typename T>
void elementwise_sub_broadcast_1c(
    const T* dinx, const T* diny, T* dout, int batch, int num);


template <typename T>
void elementwise_sub_broadcast_n1(
    const T* dinx, const T* diny, T* dout, int batch,int num);
...
template <typename T>
void elementwise_mul_broadcast_1c(
    const T* dinx, const T* diny, T* dout, int batch,int num);

template <typename T>
void elementwise_mul_broadcast_n1(
    const T* dinx, const T* diny, T* dout, int batch, int num);
...
template <typename T>
void elementwise_div_broadcast_1c(
    const T* dinx, const T* diny, T* dout, int batch, int num);

template <typename T>
void elementwise_div_broadcast_n1(
    const T* dinx, const T* diny, T* dout, int batch, int num);
...
template <typename T>
void elementwise_pow_broadcast_1c(
    const T* dinx, const T* diny, T* dout, int batch, int num);

template <typename T>
void elementwise_pow_broadcast_n1(
    const T* dinx, const T* diny, T* dout, int batch, int num);
