...
public:
    ...
    bool activeCamera(std::string camera_address, int pixel_format=1, CameraType camera_type=CAMERA_NETWORK, int cache_size=15, bool get_then_remove = false);
    bool addCamera(std::string camera_address, int pixel_format=1, CameraType camera_type=CAMERA_NETWORK, int cache_size=15, bool get_then_remove = false);
