...
int main(int argc, char** argv){
...
#endif
    // index_t input_shape[4]={1,10,10,3};
    // index_t filter_shape[4]={4,1,3,3};
    // int dilations[2]={1,1};
    // int strides[2] = {1,1};
    // nano::Padding padding=nano::SAME;
    // index_t output_shape[4];
    // int padding_size[2];
    // CalcPaddingAndOutputSize(input_shape, NHWC,filter_shape,OIHW,dilations,strides,padding,output_shape,padding_size);
    // std::cout<<"output shape"<<std::endl;
    // std::cout<<output_shape[0]<<" "<<output_shape[1]<<" "<<output_shape[2]<<" "<<output_shape[3]<<std::endl;
    // std::cout<<"padding size"<<std::endl;
    // std::cout<<padding_size[0]<<" "<<padding_size[1]<<std::endl;
    ...
    // is_ok = eagleeye_test_set_input("INPUT NODE", data, data_size, 3);
    // if(is_ok){
    ...
    // is_ok = eagleeye_test_get_output("OUTPUT NODE/OUTPUT PORT",out_data, out_data_size, out_data_dims, out_data_type);   
    // if(is_ok){
